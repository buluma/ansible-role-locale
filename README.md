# [Ansible role locale](#ansible-role-locale)

Configure locale on your system.

|GitHub|Issues|Pull Requests|Version|Downloads|
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-locale/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-locale/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-locale.svg)](https://github.com/buluma/ansible-role-locale/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-locale.svg)](https://github.com/buluma/ansible-role-locale/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-locale.svg)](https://github.com/buluma/ansible-role-locale/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/locale)](https://galaxy.ansible.com/ui/standalone/roles/buluma/locale/documentation)|
...
If you find issues, please register them on [GitHub](https://github.com/buluma/ansible-role-locale/issues).
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-locale/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-locale
